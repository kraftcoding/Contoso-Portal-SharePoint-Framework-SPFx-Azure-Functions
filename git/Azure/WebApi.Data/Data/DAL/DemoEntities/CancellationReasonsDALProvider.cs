...
public class CancellationReasonsDALprovider : BaseSPListDALprovider<TablaMaestraDAO>
{
    public override string ListSiteRelavteUrl => ListsSiteRelativeUrls.RegistroDemoEntities.CancellationReasons;
