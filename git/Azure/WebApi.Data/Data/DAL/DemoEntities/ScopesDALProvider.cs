...
public class ScopesDALprovider : BaseSPListDALprovider<TablaMaestraDAO>
{
    public override string ListSiteRelavteUrl => ListsSiteRelativeUrls.RegistroDemoEntities.Scopes;
