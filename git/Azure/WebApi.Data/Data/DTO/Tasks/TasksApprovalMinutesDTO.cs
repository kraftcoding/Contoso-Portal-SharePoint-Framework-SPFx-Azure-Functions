...
{
    public class TasksApprodvalMinutesDTO : JsonFileListItemAbstractionDTO<TasksApprodvalMinutesDAO, TasksApprodvalMinutesJsonDAO>
    {
        ...
        public DateTime Created { get => ItemDAO.Created; set => ItemDAO.Created = value; }
