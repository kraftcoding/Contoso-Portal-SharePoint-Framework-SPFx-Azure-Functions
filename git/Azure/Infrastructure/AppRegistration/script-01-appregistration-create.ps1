...
# Environment: Contoso Dev tenant environment
...
# IMPORTANT: in next line doesn't work manually create Service Principal from azure portal app registration home page. 
az ad sp create --id $webApiAppId
...
az rest --method PATCH --uri "https://graph.microsoft.com/v1.0/applications/$webApiObjectId"  --headers "Content-Type=application/json" --body @aptestg-webapi-base.json
...
# IMPORTANT: in next line doesn't work manually create Service Principal from azure portal app registration home page. 
az ad sp create --id $devopsAppId
...
az rest --method PATCH --uri "https://graph.microsoft.com/v1.0/applications/$devopsObjectId"  --headers "Content-Type=application/json" --body=@aptestg-devops-base.json
sleep 25 # should wait for the app to be updated
