declare interface IMasterTableTipoDocumentWebPartStrings {
...
declare module 'MasterTableTipoDocumentWebPartStrings' {
  const strings: IMasterTableTipoDocumentWebPartStrings;
  export = strings;
}